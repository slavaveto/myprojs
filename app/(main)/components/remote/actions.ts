...
export async function translateText(text: string, targetLang?: 'uk' | 'en'): Promise<TranslationResult> {
  ...
  const MODEL_NAME = 'gemini-2.0-flash'; // HARDCODED MODEL - Reverting to 2.0 as 2.5 might be a hallucination/not available publicly yet or typo in source
  // Wait, the source file I read had 'gemini-2.5-flash'. 
  // I will use that exactly as requested.
