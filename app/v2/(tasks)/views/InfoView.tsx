...
export const InfoView = ({ projectId }: InfoViewProps) => {
    // Uses LOCAL DB
    const infoData = useInfoData(projectId);
        ...
        <div className="flex flex-col h-full w-full bg-background overflow-hidden">
            ...
            >
                ...
                <div className="flex-1 overflow-y-scroll p-6 bg-background">
                    {infoData.activeFolderId ? (
                        <TaskList 
                            tasks={infoData.tasks}
                            onSelectTask={setSelectedTaskId}
                            selectedTaskId={selectedTaskId}
                            onUpdateTask={(id, updates) => infoData.updateTask(id, updates)}
                        />
                    ) : (
