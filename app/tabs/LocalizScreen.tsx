...
import { Input, Button, Tabs, Tab, useDisclosure, Chip } from '@heroui/react';
import { clsx } from 'clsx';
import { Plus as IconPlus, RefreshCw as IconRefresh, Search as IconSearch } from 'lucide-react';
import { EditItemModal } from '@/app/tabs/components/EditItemModal'; // Local import
import { SortableRow } from '@/app/tabs/components/SortableRow'; // Local import

import { useAsyncAction } from '@/utils/supabase/useAsyncAction';
import { StatusBadge } from '@/utils/supabase/StatusBadge';
import { useLocalizActions } from '@/app/tabs/hooks/useLocalizActions'; // Local import
// REMOVED: import { AdminUserMenu } from '@/app/admin/AdminUserMenu';
// REMOVED: import { usePermission } from '@/app/admin/_services/usePermission';
...
export const LocalizScreen = ({ onReady, isActive, texts, showToast = true }: LocalizScreenProps) => {
   ...
   // REMOVED: const { user, isLoaded } = useUser();
   // REMOVED: const { can, isLoading: isPermissionLoading } = usePermission();
   ...
   // REMOVED: if (isPermissionLoading) return null;
   // REMOVED: if (!can(PERMISSIONS.MANAGE_LOCALIZATION)) ...
