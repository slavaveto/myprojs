...
import { Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, Chip, Input, Button, SortDescriptor, Popover, PopoverTrigger, PopoverContent, Select, SelectItem } from '@heroui/react';
import { useUserActions } from '@/app/tabs/hooks/useUserActions'; // Local import
...
// REMOVED: import { AdminUserMenu, profileUpdateEvent } from '@/app/admin/AdminUserMenu';
...
export const UsersScreen = ({ onReady, isActive, texts, showToast = true }: UsersScreenProps) => {
  ...
  useEffect(() => {
    loadUsers();
    // REMOVED: profileUpdateEvent listener
  }, [loadUsers]);
  ...
  // REMOVED: if (!can(PERMISSIONS.MANAGE_USERS)) ...
