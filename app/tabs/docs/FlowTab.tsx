...
export default function FlowTab({ projectId, projectLocalPath }: FlowTabProps) {
  ...
  return (
    <div className="h-full flex font-sans bg-gray-50/50 overflow-hidden">
      ...
      <div className="w-[300px] border-r border-gray-200 flex flex-col flex-shrink-0 bg-white">
         <div className="h-14 border-b border-gray-100 flex items-center justify-between px-4 flex-shrink-0 bg-white z-10">
             ...
             <Popover placement="bottom-end" isOpen={isScanOpen} onOpenChange={setIsScanOpen} shouldFlip>
                <PopoverTrigger>
                    <Button size="sm" variant="flat" className="h-8 min-w-0 bg-gray-50 hover:bg-gray-100 text-gray-600 text-xs font-medium px-3 gap-2 border border-gray-200">
                        <ScanSearch size={14} />
                        <span>Scan Refs</span>
                    </Button>
                </PopoverTrigger>
