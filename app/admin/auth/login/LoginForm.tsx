...
import { Button, Input, Card, CardBody, CardHeader, Alert, Link } from '@heroui/react';
...
export default function AdminLoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Простая обработка ошибок Clerk
  ...
  return (
    <Card className="w-full max-w-[400px] shadow-medium bg-content1">
      <CardHeader className="flex flex-col gap-2 items-center pt-8 px-8 pb-0">
        ...
        <h1 className="text-2xl font-bold text-center">Администрирование</h1>
      ...
      <CardBody className="px-8 py-8">
        ...
        <div className="text-center text-sm text-default-500 mt-4">
           Нет аккаунта?{' '}
           <Link href="/admin/auth/signup" size="sm" className="text-primary font-medium">
              Зарегистрироваться
           </Link>
        </div>
      </div>
